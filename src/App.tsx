...
export default function App() {
  const { state, assignShot, clearShot } = useShotState();
  ...
  return (
    <div className="page">
      <header className="page-header">
        <h1>Event Shot Tracker</h1>
        <p className="page-subtitle">Affiliate coverage checklist</p>
      </header>

      <section className="progress" aria-label="Progress summary">
